...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php elseif ($add_html5_shim): ?>
    ...
    <![endif]-->
  <?php endif; ?>
  <link rel="stylesheet" href="/sites/all/themes/theedsbook/css/jquery-ui-1.10.0.custom.css" />
  <link rel="stylesheet" href="/sites/all/themes/theedsbook/css/jquery-ui-1.10.0.custom.min.css" />
  <script src='/sites/all/themes/theedsbook/js/jquery-1.9.0.js'></script>
  <script src='/sites/all/themes/theedsbook/js/jquery-ui-1.10.0.custom.js'></script>
  <script src='/sites/all/themes/theedsbook/js/jquery-ui-1.10.0.custom.min.js'></script>
  <script src='/sites/all/themes/theedsbook/js/modernizr.custom.05935.js'></script>
